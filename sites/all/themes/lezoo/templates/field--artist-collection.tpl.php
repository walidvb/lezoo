...
<?php 
	$name = (!empty($row['field_link']) && $view_mode == 'full') ? l($row['field_artist_name']->name, $row['field_link']['url'], array('attributes' => $row['field_link']['attributes'])) : $row['field_artist_name']->name;
	$origins = array();
