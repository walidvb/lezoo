...
function initGui(){
  ...
  // gui.add(params, 'grid', false).listen();
  ...
  gui.add(params, "background", 0.0, 1.0).listen().onChange(function () { skyMat.color.setRGB(249,246,239);});
  ...
  gui.add(params, "vignette",false).listen();
  // gui.show();
