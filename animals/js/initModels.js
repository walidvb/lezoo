...
//  //CUSTOM
  ...
  models.push({"file": 'files/models/animals/tarbuffaloA_tarbuffaloB.js', "type": 'animal', "centerY": 80, "riseY" : 0, "speed": 0.65});
  models.push({"file": 'files/models/animals/sealRun_bearBrown.js', "type": 'animal', "centerY": 60, "riseY" : 0, "speed": 0.45});
  models.push({"file": 'files/models/animals/parrot.js', "type": 'animal', "centerY": 0, "riseY" : 80, "speed": 0.7});
  models.push({"file": 'files/models/animals/fox.js', "type": 'animal', "centerY": 50, "riseY" : 0, "speed": 0.5});
  models.push({"file": 'files/models/animals/rabbit.js', "type": 'animal', "centerY": 50, "riseY" : 0, "speed": 0.5});
  models.push({"file": 'files/models/animals/retreiver_bearBlack.js', "type": 'animal', "centerY": 50, "riseY" : 0, "speed": 0.5});
  models.push({"file": 'files/models/animals/toad.js', "type": 'animal', "centerY": 30, "riseY" : 0, "speed": 0.2});
  models.push({"file": 'files/models/animals/treefrog.js', "type": 'animal', "centerY": 30, "riseY" : 0, "speed": 0.2});
  models.push({"file": 'files/models/animals/hummingbird.js', "type": 'animal', "centerY": 0, "riseY" : 70, "speed": 0.2});
  //TRIGGERS
  ...
  // models.push({"file": 'files/models/city/City.TriggerMesh_Car_.js', "base": 'files/models/city/City.Car_.js', "type": 'trigger', "centerY": 90, "effector": [0,0,2800,0,0,1000]});
  // models.push({"file": 'files/models/city/City.TriggerMesh_CarNiss_.js', "base": 'files/models/city/City.CarNiss_.js', "type": 'trigger', "centerY": 90, "effector": [0,0,2800,0,0,1000]});
  ...
  // models.push({"file": 'files/models/city/City.TriggerMesh_ailTrain_.js', "base": 'files/models/city/City.RailTrain_.js', "type": 'trigger', "centerY": 200, "effector": [0,-2000,0,0,800,0]});
  ...
  for (var i in models){
    ...
    link[models[i].name].style.backgroundImage = 'url("/asset_viewerfiles/thumbnails/'+models[i].name+'.png")';
...
function modelLoader(id) {
  if(models[id].geometry !== 'undefined' ){
    link[models[id].name].style.backgroundImage = 'url("/asset_viewerfiles/thumbnails/loading64.gif")';
    loader = new THREE.JSONLoaderAjax();
    loader.load({ model: models[id].file, callback: function(g) {
      models[id].geometry = g;
      switchModel(id);
      link[models[id].name].style.backgroundImage = 'url("/asset_viewerfiles/thumbnails/'+models[id].name+'.png")';
    } });
  } //else switchModel(id);
...
function switchModel(id) {
  ...
  if (models[id].type == "trigger"){
    ...
    baseLoader.load( { model: models[id].base, callback: function( geometry ) {
      ...
      lightmapShader.uniforms[ 'faceLight' ].texture = THREE.ImageUtils.loadTexture("/asset_viewerfiles/models/city/"+triggerBase.geometry.materials[0][0].map.sourceFile)
